...
const SHOW_METRICS_KEY = "approofworkspace_show_chat_metrics";
const SHOW_METRICS_EVENT = "approofworkspace_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `approofworkspace_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `approofworkspace_show_chat_metrics` key
 * @returns {void}
 */
