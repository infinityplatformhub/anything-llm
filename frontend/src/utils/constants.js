...
export const USER_PROMPT_INPUT_MAP = "approofworkspace_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "approofworkspace_pending_home_message";

export const APPEARANCE_SETTINGS = "approofworkspace_appearance_settings";
