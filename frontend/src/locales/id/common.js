...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "ApproofWorkspace dapat bekerja dengan banyak penyedia LLM. Ini akan menjadi layanan yang menangani obrolan.",
    },
    userSetup: {
    ...
    survey: {
      title: "Selamat Datang di ApproofWorkspace",
      description:
        "Bantu kami membuat ApproofWorkspace yang sesuai dengan kebutuhan Anda. Opsional.",
      email: "Apa email Anda?",
      useCase: "Untuk apa Anda akan menggunakan ApproofWorkspace?",
      useCaseWork: "Untuk pekerjaan",
      useCasePersonal: "Untuk penggunaan pribadi",
      useCaseOther: "Lainnya",
      comment: "Bagaimana Anda mengetahui ApproofWorkspace?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Aktifkan alat tanpa batas dan kurangi penggunaan token hingga 80% per kueri — ApproofWorkspace secara otomatis memilih keterampilan yang tepat untuk setiap prompt.",
        "max-tools": {
          title: "Alat Maksimal",
          description:
  ...
  customization: {
    interface: {
      title: "Preferensi UI",
      description: "Atur preferensi UI Anda untuk ApproofWorkspace.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label instance ApproofWorkspace Anda dengan branding kustom.",
    },
    chat: {
      title: "Obrolan",
      description: "Atur preferensi obrolan Anda untuk ApproofWorkspace.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Pilih bahasa pilihan untuk merender UI ApproofWorkspace - saat terjemahan tersedia.",
      },
      logo: {
        title: "Logo Merek",
        description:
  ...
  api: {
    title: "Kunci API",
    description:
      "Kunci API memungkinkan pemegangnya untuk mengakses dan mengelola instance ApproofWorkspace ini secara terprogram.",
    ...
    modal: {
      ...
      helper:
        "Setelah dibuat, kunci API dapat digunakan untuk mengakses dan mengonfigurasi instance ApproofWorkspace ini secara terprogram.",
      name: {
        label: "Nama",
  ...
  llm: {
    title: "Preferensi LLM",
    description:
      "Ini adalah kredensial dan pengaturan untuk penyedia obrolan & embedding LLM pilihan Anda. Penting bahwa kunci ini terkini dan benar, atau ApproofWorkspace tidak akan berfungsi dengan baik.",
  ...
  transcription: {
    ...
    "warn-start":
      "Menggunakan model whisper lokal pada mesin dengan RAM atau CPU terbatas dapat membuat ApproofWorkspace terhenti saat memproses berkas media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding adalah proses mengubah teks menjadi vektor. Kredensial ini diperlukan untuk mengubah berkas dan prompt Anda menjadi format yang dapat diproses oleh ApproofWorkspace.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Ini adalah kredensial dan pengaturan untuk bagaimana instance ApproofWorkspace Anda akan berfungsi. Penting bahwa kunci ini terkini dan benar.",
    provider: {
  ...
  telegram: {
    title: "Bot Telegram",
    description:
      "Hubungkan instance ApproofWorkspace Anda ke Telegram sehingga Anda dapat mengobrol dengan ruang kerja Anda dari perangkat apa pun.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Lindungi instance ApproofWorkspace Anda dengan kata sandi. Jika Anda lupa, tidak ada metode pemulihan, jadi pastikan Anda menyimpan kata sandi ini.",
  ...
  privacy: {
    ...
    description:
      "Ini adalah konfigurasi Anda tentang bagaimana penyedia pihak ketiga yang terhubung dan ApproofWorkspace menangani data Anda.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Berkas ini akan diunggah ke pemroses dokumen yang berjalan di instance ApproofWorkspace ini. Berkas ini tidak dikirim atau dibagikan dengan pihak ketiga.",
    },
    pinning: {
      what_pinning: "Apa itu pinning dokumen?",
      pin_explained_block1:
        "Saat Anda <b>pin</b> dokumen di ApproofWorkspace, kami akan menyuntikkan seluruh konten dokumen ke dalam jendela prompt Anda agar LLM Anda dapat memahaminya sepenuhnya.",
      pin_explained_block2:
        "Ini bekerja paling baik dengan <b>model konteks besar</b> atau berkas kecil yang penting untuk basis pengetahuannya.",
      pin_explained_block3:
        "Jika Anda tidak mendapatkan jawaban yang Anda inginkan dari ApproofWorkspace secara bawaan, maka pinning adalah cara yang bagus untuk mendapatkan jawaban berkualitas lebih tinggi dalam satu klik.",
      accept: "Oke, mengerti",
    },
    watching: {
      what_watching: "Apa fungsi memantau dokumen?",
      watch_explained_block1:
        "Saat Anda <b>memantau</b> dokumen di ApproofWorkspace, kami akan <i>secara otomatis</i> menyinkronkan konten dokumen Anda dari sumber aslinya secara berkala. Ini akan secara otomatis memperbarui konten di setiap ruang kerja tempat berkas ini dikelola.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memori",
        placeholder:
          "mis. Nama pengguna adalah Joe, Pengguna bekerja pada ApproofWorkspace, dll.",
        create: "Buat",
        save: "Simpan",
        cancel: "Batal",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Anda perlu mengautentikasi dengan Community Hub ApproofWorkspace sebelum mempublikasikan item.",
