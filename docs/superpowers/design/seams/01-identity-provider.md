...
`OidcIdentityProvider`: generic Authorization Code + PKCE driver for Google, Entra, and Lark-compatible OIDC discovery. Core applies email-domain policy after normalization.
