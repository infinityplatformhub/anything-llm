...
- **main**:  40ded26b — 40/51 closed. #27 + #45 MERGED. Gating: #32 0b7bc383 (QA-1 re-review pending). Next: t7 (#31 Dev2 final rebase on 40ded26b) → #50. Dev1 → #35 PR-4d. Dev4 → #30 T-5 in 3 slices (branch approof/t5-vector-filter, base ca7041cb+). S1 #36 Dev3 coding.
