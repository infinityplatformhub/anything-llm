...
- **main**:  19e29acd — 41/51 closed. #27 #45 #32 MERGED (EMBED_REQUIRE_SESSION_TOKEN off until #49). Gating: #31 t7 51e15238 (Dev2 fixing myCapabilities.test.js user leak → new SHA → regate). Next: t7 → #50 (Dev2 then #43 S2). Dev1 #35 rulings issued (split key.manage; intersection). Dev4 #30 slice 1. Dev3 S1 T1-T3 done 2bbb6a6b. Techlead §2.1 PASS both halves 7dff4ca1.
