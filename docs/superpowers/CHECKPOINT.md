...
- **main**:  c80905b0 — 38/50 closed. Order: pr4c(#27 Dev1 rebasing) → #32 fix (Dev4, BLOCKER-1 oracle) → t7 (#31 2a911a7e + policyRepository inTransaction recipe) → #50 S1-cleanup (simple-SSO delete, split from #36 R3). S1 #36 Dev3 OIDC-only on c80905b0 slots 080000/081000 (Q-3 purge TTL 15m, Q-4 limiter, D-2 reject-only). #49 widget token. #45 paused for #32.
