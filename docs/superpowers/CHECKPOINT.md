...
- **main**: 92720eac — 43/58 closed. #52 b1dbd4e5 regate PASS 1219/1219 (wt-52 kept) — QA-2 PASS + Techlead PASS; merge on QA-1 verdict; then Dev2 #58 (4 raw mode readers) → #50 → #53; QA-1 PASS, Techlead PASS, QA-2 PASS scoped + HIGH addendum 7 (isSingleUserMode drift, 3 routes) folded into new SHA (1209/1209; requireSelfSession on /system/user + /web-push; sweep 20 routes; admin.js:313 user.manage; guard formula; 072000 seed WITHDRAWN — org-wide workspace.read matches every workspace; view-as-user reads wait #53). Techlead PASS (nit: enable-multi-user on true single-user needs a test); QA-1 harness + QA-2 single-user probe pending (§7.11); #53 ruling (ข) permissions.scope column in-scope. Then #50 → #53 (Dev2). #30 slice 1a Dev4, S1 T7-T8 Dev3, #41 3d37ae81 HOLD (Techlead: normalizePath docpath mismatch, silent attach fail, no write-half tests → Dev1 new SHA); Dev1 → #48 recon. Queue: #43 #40 after #52; #48 #51 #55 after #41; #49 #54 #56 #57 after #30.
