...
- **main**: ca5d3b68 — 44/58 closed. #52 MERGED b1dbd4e5. #41 674d8f19 regate PASS 1250/1250 (wt-41 kept) — Techlead PASS; QA-1/QA-2 verdicts pending §7.11 → merge; Dev1 → #48 recon (docs/superpowers/recon/credential-store-dc.md). #36 S1 c9a0863f gate PASS 1296/1296 + QA-1 PASS (wt-36 kept) — Techlead verdict pending; Dev3 → S2 #43 on branch from c9a0863f (rulings in s2-entra-saml.md §PMO). #30 slice 1a 52b3d176 HOLD (Techlead: flag dead code → ruling (ก) predicate OR-unlabelled in every dialect; Dev4 new SHA then rebase 1b). #58 d5da4d88 GATING 1243/1243 (A/B inverted + mobile; ruling C refuse-to-boot as separate commit → final SHA); then #50 → #53. Queue: #51 #55 #57 after #41; #49 #54 #56 after #30; #40 after #53.
