...
- **ปิดแล้ว 32 issues**: #1-#14, #16-#26, #29, #33, #34, #37, #38, #42
...
- **main**:  fd1a793c — 42/54 closed. #52 LIVE HOLE (Dev2 partial f2c994dc; addendum 5: requireSelfSession on /system/user + /web-push/subscribe, 20 engine-less routes via router-stack sweep; final ruling in gh issue 52 comments: requirePermission on 4 exploitable routes /system/user /onboarding /web-push/subscribe /enable-multi-user; router-stack sweep test 29 engine-less routes; 4 read routes → workspace.read; admin.js:313 → user.manage BEFORE seeding workspace.read to member 072000; guard = permissions(R) ⊆ granter ∪ BASELINE_GRANTABLE[chat.send]; QA-1 verdict before merge). #35 c116d9fa gate PASS 1217/1217 (wt-35 kept) — merge waits QA-1 verdict §7.11; Dev1 → #41 RED→GREEN (rulings: strict join, upload auto-attach, folder 403, comment fix) (clean main 1197/1197; Dev1's 6 reds were worktree-local). #30 slice 1a Dev4 (9 call sites wired; lance+pgvector+milvus, others fail-closed; fixture (ก); #54 write-side asymmetry opened), S1 T7-T8 Dev3. Queue: #50 #43 #53 #40 after #52; #41 #48 #51 after #35; #49 after #30.
