...
- **main**:  3060171c — 42/52 closed. LIVE HOLE: #52 (impersonated session mutates via engine-less routes; setup_admin cannot grant) — Dev2 hotfix FIRST (revised: engine wiring + router-sweep test, BASELINE_GRANTABLE carve-out, no migration), then #50. QA-2 sweeping all engine-less mutating routes. Dev1 #35, Dev4 #30 slice 1, Dev3 S1 T7-T8. §7.10 resetModules, §7.11 review-is-a-gate added.
