...
- **t4b `3468c867`** gate FAIL 1 literal (membershipGrantRole.test.js:50) → Dev4 fixing → new SHA → regate → merge NEXT · **#39 `d4fbe651`** (gate PASS at 10b7fe44 948/948; +routeWiring STORAGE_DIR fix) conflicts t4b in JobRuntime.js → Dev2 rebases after t4b · checklist §2.5 merged 3bf21384 · #33p2 QA-1 PASS
