...
- **main**:  d3a02c5a — 43/55 closed. #52 cf0b6af2 GATING (1209/1209; requireSelfSession on /system/user + /web-push; sweep 20 routes; admin.js:313 user.manage; guard formula; 072000 seed WITHDRAWN — org-wide workspace.read matches every workspace; view-as-user reads wait #53). QA-1 harness + QA-2 single-user probe + Techlead review pending (§7.11). Then #50 → #53 (Dev2). #30 slice 1a Dev4, S1 T7-T8 Dev3, #41 Dev1 (404 §3.4, 4 upload routes auto-attach, generated-files 403 → #55). Queue: #43 #40 after #52; #48 #51 #55 after #41; #49 #54 after #30.
