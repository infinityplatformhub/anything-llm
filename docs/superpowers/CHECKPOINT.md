...
- **เปิดอยู่ 4**: #7 (subagent dev-7, env7 — symlink/temp-name fixes in progress, SHA จะเปลี่ยน), #15 (Dev3 6/12, rebase บน 3c0048b1 เพื่อ spec 09), #22 T-3 (Dev4, t3 core `3b80ba34` + B-2 resolver workspaceIds + F-20d + afterAll timeout รอ SHA), #25 T-4a route wiring (recon `.infi/recon/t4a-route-wiring.md`, rulings: B-1 grants(creator)∩scopes, W-5 → T-4b, no migration slot — รอ dev ใหม่)
- **main code**: `3c0048b1` (T-2, #23, #24 hotfix merged)
