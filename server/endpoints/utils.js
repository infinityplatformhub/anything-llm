 ...
 * as well as build features in ApproofWorkspace directly for a specific model or capabilities.
 *
...
/**
 * Returns the user agent for the ApproofWorkspace deployment.
 * @returns {string} The user agent.
 */
function getAnythingLLMUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `ApproofWorkspace/${version}`;
}
