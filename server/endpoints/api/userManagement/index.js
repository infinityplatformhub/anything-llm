...
function apiUserManagementEndpoints(app) {
  ...
  app.get("/v1/users", [validApiKey(scopeFor("GET", "/v1/users"))], async (request, response) => {
    /*
  ...
  app.get(
    ...
    [ssoIssuanceLock, validApiKey(scopeFor("GET", "/v1/users/:id/issue-auth-token")), simpleSSOEnabled],
