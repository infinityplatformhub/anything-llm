...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to ApproofWorkspace to be parsed and prepared for embedding, with optional metadata.'
    #swagger.requestBody = {
        ...
        "application/json": {
          schema: {
            ...
            example: {
              ...
              documents: [
                {
                  "location": "custom-documents/approofworkspace.txt-6e8be64c-c162-4b43-9997-b068c0071e8b.json",
                  "name": "approofworkspace.txt-6e8be64c-c162-4b43-9997-b068c0071e8b.json",
                  "url": "file:///Users/tim/Documents/anything-llm/collector/hotdir/approofworkspace.txt",
                  "title": "approofworkspace.txt",
                  "docAuthor": "Unknown",
                  "description": "Unknown",
                  "docSource": "a text file uploaded by the user.",
                  "chunkSource": "approofworkspace.txt",
  ...
  app.post(
    ...
    async (request, response) => {
      /*
      #swagger.tags = ['Documents']
      #swagger.description = 'Upload a new file to a specific folder in ApproofWorkspace to be parsed and prepared for embedding. If the folder does not exist, it will be created.'
  ...
  app.post(
    ...
    async (request, response) => {
      /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Upload a valid URL for ApproofWorkspace to scrape and prepare for embedding. Optionally, specify a comma-separated list of workspace slugs to embed the document into post-upload.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "url": "file://approofworkspace_com.html",
                  "title": "approofworkspace_com.html",
                  "docAuthor": "no author found",
                  "description": "No description found.",
                  "docSource": "URL link uploaded by the user.",
                  "chunkSource": "https:approofworkspace.com.html",
                  "published": "1/16/2024, 3:46:33 PM",
                  "wordCount": 252,
                  "pageContent": "ApproofWorkspace is the best....",
                  "token_count_estimate": 447,
                  "location": "custom-documents/url-approofworkspace_com-c530dbe6-bff1-4b9e-b87f-710d539d20bc.json"
                }
              ]
            }
          }
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in ApproofWorkspace.",
              "addToWorkspaces": "workspace1,workspace2",
              "metadata": {
