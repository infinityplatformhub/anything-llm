...
const Workspace = {
  ...
  update: async function (id = null, updates = {}) {
    ...
    // When switching to approofworkspace-router, chatModel is not used.
    // When switching away from approofworkspace-router, clear router_id.
    if (validatedUpdates?.chatProvider === "approofworkspace-router") {
      validatedUpdates.chatModel = null;
    } else if (
      validatedUpdates?.chatProvider &&
      validatedUpdates.chatProvider !== "approofworkspace-router"
    ) {
  ...
  supportsNativeToolCalling: async function (workspace = {}) {
    ...
    if (provider === "approofworkspace-router") {
