 ...
 *
 * The `/v1` leg of S-20 is NOT here: grant enforcement on `/v1` is T-4b's W-8
 * (`4eab9839`), which is not in this branch's base. It belongs in the post-
 * rebase run, and is recorded in ledger-31 rather than left as a silent gap.
 */
