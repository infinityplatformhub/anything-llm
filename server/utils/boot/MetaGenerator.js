...
class MetaGenerator {
  ...
  #defaultManifest = {
    name: "ApproofWorkspace",
    short_name: "ApproofWorkspace",
    display: "standalone",
  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "ApproofWorkspace | Your personal LLM trained on anything",
      },
      ...
      this.#customConfig = this.#defaultMeta().map((tag) => {
        ...
        if (tag.tag === "title") {
          return {
            ...
            content:
              customTitle ??
              "ApproofWorkspace | Your personal LLM trained on anything",
          };
        }
        // Override meta title
