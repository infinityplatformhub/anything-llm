 ...
 * Handles communication with the ApproofWorkspace Google Calendar Google Apps Script deployment.
 */
    ...
    try {
      const response = await fetch(this.#getBaseUrl(), {
        ...
        headers: {
          ...
          "X-ApproofWorkspace-UA": "ApproofWorkspace-GoogleCalendar-Agent/1.0",
        },
        body: JSON.stringify({
          key: this.#apiKey,
          action,
