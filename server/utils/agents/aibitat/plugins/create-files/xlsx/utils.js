...
/**
 * Applies ApproofWorkspace branding to an Excel workbook.
 * Adds a subtle "Created with ApproofWorkspace" text row below the data on each sheet.
...
function applyBranding(workbook) {
  for (const worksheet of workbook.worksheets) {
    ...
    brandingCell.value = "Created with ApproofWorkspace";
    brandingCell.font = {
      italic: true,
      size: 9,
      color: { argb: "FF999999" },
